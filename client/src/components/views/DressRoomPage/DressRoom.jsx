...
const DressRoom = (props) => {
        ...
        await navigator.mediaDevices
            ...
            .then((stream) => {
                ...
                socketRef.current.on("other user", async (userID) => {
                    ...
                    mouseChannel.current =
                        await peerRef.current.createDataChannel("mouse");
                    mouseChannel.current.addEventListener(
                        "message",
                        (event) => {
                    ...
                    itemChannel.current =
                        await peerRef.current.createDataChannel("item");
    ...
    const handleSelectShopBtn = (clickedShop) => {
        ...
        if (selectedShops.includes(clickedShop)) {
            setSelectedShops(
                selectedShops.filter((shop) => shop !== clickedShop)
            );
        } else {
                        ...
                        <div className={styles.video_container}>
                            <div className={styles.user1}>
                                ...
                                <div className={styles.control_box1}>
                                    ...
                                    <button
                                        className={
                                            (styles.micBtn, styles.controlBtn)
                                        }
                                    ...
                                    <button
                                        className={
                                            (styles.muteBtn, styles.controlBtn)
                                        }
